            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="color: #19b89d";>Report</h4>
                    </div>
...
while ($data=mysqli_fetch_assoc($run1)) 
{
 ...
 ?>
    <tr>
      ...
      <td><a href="Pdf.php?id=<?php echo $data['id']; ?>" target="_blank"><button class="btn btn-primary" data-toggle="modal" data-target="#openModalButton"data-id="" style="background-color:#19b89d; " >PDF</button></a></td>
      <!-- <td class=""></td>
