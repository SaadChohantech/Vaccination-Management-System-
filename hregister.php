...
if (isset($_POST['Register']))
 {
    ...
    $query="SELECT * from `hregister` where `email`= '$email'";
    ...
    if ($count==1) {
      ...
      {
          $query="INSERT INTO `hregister`(`Name`, `email`, `password`, `address`) VALUES 
          ('$name','$email','$pass','$addr')";
          $run=mysqli_query($db,$query);
          if ($run==true) {
...
.butt:hover
{
 ...
 <body>
      ...
      <div class="container">
        ...
        <h2 class="one mt-3" >Hospital Register</h2>
        <div class="mb-3">
        <label class="form-label" style="color: #0cbe9d;">Hospital Name</label>
...
<div class="mb-3">
      ...
      <div class="mb-3">
        <label class="form-label" style="color: #0cbe9d;">Address</label>
        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Enter Your Email" name="address">
      </div>

      <p class="forr">Already Register <span><a href="hlogin.php" class="third">Sign in</span></p>
