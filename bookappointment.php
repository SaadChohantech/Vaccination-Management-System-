            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="color: #19b89d";>Book Appointment</h4>
                    </div>
...
<form method="POST" action="badd.php">
  <div class="form-group">
    ...
    <!-- <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Enter Child Name" name="name"> -->
...
$rowr= mysqli_fetch_array($runs);

$id= $rowr['id'];

$query3="SELECT *FROM `addchild` where `user_id` = '$id'";
$run3= mysqli_query($db, $query3);
// $results= mysqli_num_rows($run1);
...
<?php   
 ...
 ?>
  ...
  <div class="form-group">
    ...
    <input type="date" class="form-control"  aria-describedby="emailHelp" placeholder="Enter Age" name="date">
    <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
  </div>
  <div class="form-group">
  <label >Gender</label>
  ...
  <label >Hospital</label>
    <select class="form-control select" name="hospi">
        <?php 
        $sqq="SELECT * FROM `hospital";
        $ru=mysqli_query($db, $sqq);
        while($dat=mysqli_fetch_assoc($ru))
        {
  ...
  <option ><?php echo $dat['name']; ?></option>  
 <?php 
...
<div class="form-group">
  <label >Vaccine</label>
    <select class="form-control select" name="vaccine">
        <?php 
        $sqqs="SELECT * FROM `vaccines` where `statues` = 'Available'";
        $rus=mysqli_query($db, $sqqs);
        while($dats=mysqli_fetch_assoc($rus))
        {
  ...
  <option ><?php echo $dats['Name']; ?></option>  
 <?php 
  ...
  <input type="submit" class="btn btn-primary mt-4" value="Submit" name="submit"  style="background-color:#19b89d; ">
</form>
...
$rowrs= mysqli_fetch_array($runs);

$id= $rowrs['id'];

$query1="SELECT *FROM `bookapp` where `user_id` = '$id'";
$run1= mysqli_query($db, $query1);
// $results= mysqli_num_rows($run1);
while ($valuu= mysqli_fetch_assoc($run1)) 
{
 ...
 ?>
    <tr>
      ...
      <td><?php  echo $valuu['Name']; ?></td>
      <td><?php  echo $valuu['date']; ?></td>
      <td><?php  echo $valuu['gender']; ?></td>
      <td><?php  echo $valuu['hospital']; ?></td>
       <td><?php echo $valuu['vaccine']; ?></td>
      <td><?php echo $valuu['status']; ?></td>

      <!-- <td class=""><a href="pupdate.php?id=<?php echo $data['Id']; ?>"><button class="btn btn-primary" data-toggle="modal" data-target="#openModalButton"data-id="" style="background-color:#19b89d; " >Update</button></a></td> -->
      
      <!-- <td><a href="pdelete.php?id=<?php echo $data['Id']; ?>"><button class="btn btn-primary" data-toggle="modal" data-target="#openModalButton"data-id="" style="background-color:#e83143; " name="delete"  onclick='return confirmDelete()' >Delete</button></a></td> -->
    </tr>
