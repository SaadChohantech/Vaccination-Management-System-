...
<form method="POST"  >
  ...
  <input type="submit" class="btn btn-primary" value="Update" name="update"  style="background-color:#19b89d; ">
</form>
...
if(isset($_POST['update']))
 {
    ...
    $query="UPDATE `hospital` SET `name`='$name',`email`='$email',`address`='$address' WHERE `id`= '$id'";
    $run= mysqli_query($db, $query);
    if ($run==true) {
