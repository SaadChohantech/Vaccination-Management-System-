...
if (isset($_POST['Login']))
 {
  ...
  // move_uploaded_file($src, $des);
	...
	$query= "SELECT * FROM `hregister` WHERE `email` = '$email' and `password` = '$pass'";
...
.butt:hover
{
 ...
 <body>
      ...
      <div class="container">
        ...
        <h2 class="one mt-3 py-2" >Hospital Login</h2>
    ...
    <div class="mb-3">
      ...
      <p class="forr">Not Register <span><a href="hregister.php" class="third">Sign Up</span></p>
