            ...
            <div class="content">
                <div class="row">
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title" style="color: #19b89d";>Vaccines</h4>
                    </div>
...
<form method="POST" action="vupdate.php">
  <div class="form-group">
    ...
    <input type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Enter Vaccine Name" name="name">
...
while($data= mysqli_fetch_assoc($run))
{
 ...
 ?>
    <tr>
      ...
      <td class=""><a href="updatev.php?id=<?php echo $data['id']; ?>"><button class="btn btn-primary" data-toggle="modal" data-target="#openModalButton"data-id="" style="background-color:#19b89d; " >Update</button></a></td>
      
      <td><a href="deletev.php?id=<?php echo $data['id']; ?>"><button class="btn btn-primary" data-toggle="modal" data-target="#openModalButton"data-id="" style="background-color:#e83143; " name="delete"  onclick='return confirmDelete()' >Delete</button></a></td>
    </tr>
<?php 
